...
import { Eye, EyeOff, User, Mail, Smartphone } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto max-w-4xl py-12 px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground mt-2">Manage your account details and security settings.</p>
      </div>
